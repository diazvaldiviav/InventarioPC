...
public class ComputadoraContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        MemoriaRamInit.Add(new MemoriaRam() { NumSerieId ="7h7g8f8fke9gtr54t6yac52", Marca = "Kingston", Tecnologia = "DD4" });
        MemoriaRamInit.Add(new MemoriaRam() { NumSerieId ="67tun7588nd7y7y4t6yac78", Marca = "HyperX", Tecnologia = "DD3" });
