...
namespace ProyectoInventarioASP.Controllers
{
    ...
    public class BajasController : Controller
    {
                        ...
                        )
        {
            ...
            nuevaBaja.id = id;
            nuevaBaja.Equipo = Equipo;
            nuevaBaja.fechaBaja = fecha;
            nuevaBaja.NumInv = NumInv;
            nuevaBaja.NumSerie = Serial;
            nuevaBaja.Marca = Marca;
            nuevaBaja.SerieBoard = boardserie;
            nuevaBaja.Micro.Tecnologia = tecnMicro;
            nuevaBaja.MotherBoard.Marca = marcaBoard;
